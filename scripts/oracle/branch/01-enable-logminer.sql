-- Enable LogMiner for Oracle CDC on Branch Server
-- Run as SYSDBA

-- Set recovery area size and location
ALTER SYSTEM SET db_recovery_file_dest_size = 20G;
ALTER SYSTEM SET db_recovery_file_dest = 
  '/u01/app/oracle/oradata/recovery_area' SCOPE=SPFILE;
...
ALTER SYSTEM SET log_archive_dest_1=
  'LOCATION=/u01/app/oracle/oradata/recovery_area VALID_FOR=(ALL_LOGFILES,ALL_ROLES) DB_UNIQUE_NAME=ORCLCDB' SCOPE=SPFILE;
