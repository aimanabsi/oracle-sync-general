package com.sync.resolver.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, ChangeEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, ChangeEvent.class);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, ChangeEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ChangeEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerFactory());
        factory.setConcurrency(3); // Number of listener threads
